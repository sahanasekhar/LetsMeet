    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent!=null && intent.getAction()!=null) {
            ...
            try {
                ...
                LinkedList<User> mutualUsers = db.getMutualUsers();
                ArrayList<RowItem> rowItems = new ArrayList<RowItem>();
                for (int i = 0; i < mutualUsers.size(); i++) {
                    try {
                        // Bitmap bitmap = getFacebookProfilePicture(id.get(i));

                        RowItem item = new RowItem(mutualUsers.get(i).getKEY_USERNAME(), mutualUsers.get(i).getKEY_USERID(), loadImageFromStorage(mutualUsers.get(i).getKEY_USERURL()));
                        rowItems.add(item);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
        ...
        final IProfile profile = new ProfileDrawerItem().withName("Rakesh Prabhu").withEmail("mikepenz@gmail.com").withIcon("https://scontent.fphx1-2.fna.fbcdn.net/hphotos-xfp1/v/t1.0-9/11855739_10205587550940373_7974574911618547961_n.jpg?oh=007484cb080fa56479ab3a78c1e17936&oe=57788D59").withIdentifier(100);
